                            ...
                            <div class="table-responsive">
                                ...
                                <table class='table' id='category_table'>
                                    ...
                                    ";
                                        ...
                                        $html .= "<td></form> <form method='POST' action='category_delete.php'><input type='hidden' name='category_id' value='$elemant[category_id]' /><button type='submit' value='delete'>Delete</button></form><form action='./category_update.php' method='POST'><button type='submit' name = '$elemant[category_id]'>Update</button><br></td></tr>";
                                        }
                                        $html .="</tbody></table>";
