...
<div class="container" style="width: 33%; min-height: 88vh;">
    <br>
    <br>
    <form action="" method="post" style="margin-top: 10%;">
      ...
      <br>
      <button style="color: white ;  box-shadow: 0 10px 15px black ; background:black ;width:6em;height:3em;border-radius:1em" type="submit" id="sub" >Login </button>
      <br>
      <?php  if ($_SERVER["REQUEST_METHOD"] === "POST"){echo "<p style='color:red'>Invalid email or password<p>";}
      ?>
      <br>
      <br>
      <a style="color:white ; font-size:20px;" href="userregister.php" class="acc">Need an account ?<span    href="userregister.php"   style="color:red"> Sign up</span> </a>
